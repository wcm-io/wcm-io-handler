...
public class FullUrlForceNonSecureUrlModeTest extends AbstractUrlModeTest {
  ...
  public void testSiteUrls() {
    ...
    assertEquals("http://de.dummysite.org", UrlModes.FULL_URL_FORCENONSECURE.getResourceUrlPrefix(adaptable(), runModes(), currentPage, null));
    ...
    assertEquals("https://author.dummysite.org", UrlModes.FULL_URL_FORCENONSECURE.getResourceUrlPrefix(adaptable(), runModes(), currentPage, null));
  ...
  public void testNoSiteUrls() {
    ...
    context.runMode(RunMode.PUBLISH);
    assertNull(UrlModes.FULL_URL_FORCENONSECURE.getLinkUrlPrefix(adaptable(), runModes(), currentPage, targetPage));
    assertNull(UrlModes.FULL_URL_FORCENONSECURE.getLinkUrlPrefix(adaptable(), runModes(), currentPage, secureTargetPage));
    assertNull(UrlModes.FULL_URL_FORCENONSECURE.getResourceUrlPrefix(adaptable(), runModes(), currentPage, null));
  ...
  public void testIntegratorModeExtended() {
    ...
    assertEquals(IntegratorPlaceholder.URL_CONTENT,
        UrlModes.FULL_URL_FORCENONSECURE.getLinkUrlPrefix(adaptable(), runModes(), currentPage, secureTargetPage));
    assertEquals(IntegratorPlaceholder.URL_CONTENT_PROXY, UrlModes.FULL_URL_FORCENONSECURE.getResourceUrlPrefix(adaptable(), runModes(), currentPage, null));
