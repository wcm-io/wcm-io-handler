...
Dialog properties for "media" link type.
...
GraniteUiSyntheticResource.child(items, LinkNameConstants.PN_LINK_MEDIA_REF, "wcm-io/handler/link/components/granite/form/mediaLinkPathField",
    linkMediaRefProps.build());

GraniteUiSyntheticResource.child(items, LinkNameConstants.PN_LINK_MEDIA_DOWNLOAD, "wcm-io/wcm/ui/granite/components/form/checkbox",
...
insertAdditionalComponents(items, cfg.getChild("mediaLinkFields"));
