...
By default, the Media Handler uses it's own set of properties (starting with "media"). For new projects it is recommended to switch to the "Adobe Standard" properties which are also by other image components.

These are the most common properties:

|Property name (wcm.io Default)|Property name (Adobes Standard)|Description
|------------------------------|-------------------------------|-----------------------------------------------|
